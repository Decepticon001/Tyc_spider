...
class Tianyancah:
    ...
    def get_info(self,url,proxy):
        ...
        html = response.text
        # print(html)
        item = self.get_other(html,item,proxy,company_id)
        selector = etree.HTML(html)
    ...
    def get_other(self,html,item,proxy,company_id):
        selector = etree.HTML(html)
        ...
        try:
            ...
            i = 2
            while page:
                res = self.session.get("https://www.tianyancha.com/pagination/invest.xhtml?pn=%s&id=%s"%(str(i),company_id)).text
        ...
        try:
            ...
            i = 2
            while page:
                res = self.session.get("https://www.tianyancha.com/pagination/branch.xhtml?pn=%s&id=%s"%(str(i),company_id)).text
        ...
        try:
            ...
            i = 2
            while page:
                res = self.session.get("https://www.tianyancha.com/pagination/changeinfo.xhtml?pn=%s&id=%s"%(str(i),company_id)).text
        ...
        try:
            ...
            i = 2
            while page:
                res = self.session.get("https://www.tianyancha.com/pagination/announcementcourt.xhtml?pn=%s&id=%s"%(str(i),company_id)).text
        ...
        try:
            ...
            i = 2
            while page:
                res = self.session.get('https://www.tianyancha.com/pagination/lawsuit.xhtml?pn=%s&name=%s'%(str(i),self.name)).text
        ...
        try:
            ...
            i = 2
            while page:
                res = self.session.get("https://www.tianyancha.com/pagination/court.xhtml?pn=%s&name=%s"%(str(i),self.name)).text
        ...
        try:
            ...
            for u in busin_url:
                ...
                res1 = self.session.get(url).text
        ...
        try:
            ...
            i = 2
            while page:
                res=self.session.get('https://www.tianyancha.com/pagination/tmInfo.xhtml?pn=%s&id=%s'%(str(i),company_id)).text
                # print(res)
        ...
        try:
            ...
            i = 2
            while page:
                res = self.session.get("https://www.tianyancha.com/pagination/copyright.xhtml?pn=%s&id=%s"%(str(i),company_id)).text
        ...
        try:
            ...
            i = 2
            while page:
                res = self.session.get("https://www.tianyancha.com/pagination/copyrightWorks.xhtml?pn=%s&id=%s"%(str(i),company_id)).text
        ...
        try:
            ...
            i = 2
            while page:
                res = self.session.get('https://www.tianyancha.com/pagination/patent.xhtml?pn=%s&id=%s'%(i,company_id)).text
